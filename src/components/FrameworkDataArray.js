const frameworks = [
  {
    ...
    description_card : "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Eget mauris pharetra et ultrices neque ornare. Ipsum dolor sit amet consectetur adipiscing.",
    description:
    ...
    description_more_p1 :       "React makes it painless to create interactive UIs. Design simple views for each state in your application, and React will efficiently update and render just the right components when your data changes.",
    description_more_p11 : "Declarative views make your code more predictable and easier to debug.",
    description_more_h2 : "Component-Based",
    description_more_p2 : "Build encapsulated components that manage their own state, then compose them to make complex UIs.",
    description_more_p21 : "Since component logic is written in JavaScript instead of templates, you can easily pass rich data through your app and keep state out of the DOM.",
    description_more_h3 : "Learn Once, Write Everywhere",
    description_more_p3 : "We don’t make assumptions about the rest of your technology stack, so you can develop new features in React without rewriting existing code.",
    description_more_p31 : "React can also render on the server using Node and power mobile apps using{''} <a href='https://facebook.github.io/react-native/'> React Native </a> .",
    logo: "",
    advantages: [
